  ...
  permissions: [],
   aliases: ["usesuperrod"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
      ...
      if (user.superfishingpass<= 0) return message.channel.send(`> ❌ You need 1 Super Fisherman Pass To Fish , You Currently Have ${user.superfishingpass} you can by buying from Eric. `);
      ...
      let names = ["sharpedo","seaking","kingdra","mantine","mantyke","blastoise","gyarados","empoleon","totodile","suicune","greninja","kyogre","palkia","dratini","squirtle","keldeo","manaphy","volcanion","phione"]
