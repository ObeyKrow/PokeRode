  ...
  permissions: [],
   aliases: ["userentrod"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
      ...
      if (user.rentfishingpass<= 0) return message.channel.send(`> ❌ You need 1 Rent Fisherman Pass To Fish ( Rent License) , You Currently Have ${user.rentfishingpass} you can by buying from Eric. `);
      ...
      await guild.save()
            user.rentfishingpass = user.rentfishingpass - 2
