...
module.exports = {
  name: "teleportpinwheelforest",
  description: "teleportpinwheelforest .",
  category: "Pokemon Commands",
  args: false,
  usage: ["teleportpinwheelforest"],
  cooldown: 15 ,
  permissions: [],
   aliases: ["teleportpinwheelforest","teleportpinwheel forest"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
     ...
     if (user.techwatch<= 0) return message.channel.send(`> ❌ You Dont Have A Tech Watch `); 
      ...
      let names = ["virizion","cobalion","terrakion","keldeo","weedle","catterpie","metapod","kakuna"]
