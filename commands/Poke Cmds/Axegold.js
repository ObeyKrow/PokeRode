  ...
  permissions: [],
   aliases: ["usegoldaxe"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
     ...
     if (user.goldaxe<= 0) return message.channel.send(`> ❌ You need 1 Gold axe to cut trees you currently have ${user.goldaxe} you can get buy it from p!axeshop. `); 
