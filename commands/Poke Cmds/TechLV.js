...
module.exports = {
  name: "teleportlakevalor",
  description: "teleportlakevalor .",
  category: "Pokemon Commands",
  args: false,
  usage: ["teleportlakevalor"],
  cooldown: 15 ,
  permissions: [],
   aliases: ["teleportlakevalor","teleportlake valor"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
     ...
     if (user.techwatch<= 0) return message.channel.send(`> ❌ You Dont Have A Tech Watch `); 
      ...
      let names = ["azelf","mesprit","uxie","magikarp","gyarados","tentacool","tentacruel","seel"]
