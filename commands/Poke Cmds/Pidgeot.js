  ...
  permissions: [],
   aliases: ["usepidgeot"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
      ...
      if (user.rentpidgeot<= 0) return message.channel.send(`> ❌ You need 1 Rented Pidgeot you currently have ${user.rentpidgeot} . `); 
