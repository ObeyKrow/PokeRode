...
.addField("Vote Streak",`${user.upvotes}`)
.addField("**Badges**",`• ${(user.owner ? ":crown: Owner" : "")}\n${(user.owner ? "• <:staff4:881553475148869743> Staff" : "")}`)
.addField("**Fishing Passes**",`
Normal Fishing Pass : ${user.normalfishingpass},
Good Fishing Pass : ${user.goodfishingpass},
Super Fishing Pass : ${user.superfishingpass}`)
.addField("**Bulldozes**",`${user.bulldoze}`)
