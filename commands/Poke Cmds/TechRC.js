...
module.exports = {
  name: "teleportrandomcave",
  description: "teleportrandomcave .",
  category: "Pokemon Commands",
  args: false,
  usage: ["teleportrandomcave"],
  cooldown: 15 ,
  permissions: [],
   aliases: ["teleportrandomcave","teleportrandom cave"],
    ...
    await get(ab).then(async x => {
       ...
       await spawn.save()
    user.techcrystals = user.techcrystals + 15
    await user.save();
