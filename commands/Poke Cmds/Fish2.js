  ...
  permissions: [],
   aliases: ["usegoodrod"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
      ...
      if (user.goodfishingpass<= 0) return message.channel.send(`> ❌ You need 1 Good Fisherman Pass To Fish , You Currently Have ${user.goodfishingpass} you can by buying from Eric. `);
      ...
      let names = ["sharpedo","seaking","kingdra","mantine","mantyke","blastoise","gyarados","empoleon","totodile","suicune"]
