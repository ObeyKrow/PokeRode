...
module.exports = {
  name: "teleportflarogarden",
  description: "teleportflarogarden .",
  category: "Pokemon Commands",
  args: false,
  usage: ["teleportflarogarden"],
  cooldown: 15 ,
  permissions: [],
   aliases: ["teleport flarogarden"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
     ...
     if (user.techwatch<= 0) return message.channel.send(`> ❌ You Dont Have A Tech Watch `); 
      ...
      let names = ["shaymin","bulbasaur","bellsom","bellsprout","venusaur","ivysaur","bellosom","gloom"]
