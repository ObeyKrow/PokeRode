  ...
  permissions: [],
   aliases: ["usealtaria"],
    execute: async (client,message, args, prefix, guild, color, channel) => {
      ...
      if (user.rentaltaria<= 0) return message.channel.send(`> ❌ You need 1 Rented Altaria you currently have ${user.rentaltaria} . `); 
      ...
      let names = ["charizard","togekiss","scyther","honchkrow","gliscor","aerodactyl","crobat","gyarados","salamence","dragonite","noibat","noivern","charizard"]
