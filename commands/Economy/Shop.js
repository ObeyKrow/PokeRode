...
module.exports = {
  ...
  execute: async (client, message, args, prefix, guild, color, channel) => {
    ...
    .setAuthor(`Balance: ${user.balance.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} Credit(s) | Shards: ${user.shards.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} | Redeems: ${user.redeems.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}\nShop 6 - Gigantamax Transformation`)
      ...
      .addField("Eternatus", `\`p!shopbuy 6 gmax eternatus\``, true)
      .addField("Venusaur", `\`p!shopbuy 6 gmax venusaur\``, true)
      .addField("Charizard", `\`p!shopbuy 6 gmax charizard\``, true)
      .addField("Blastoise", `\`p!shopbuy 6 gmax blastoise\``, true)
      .addField("Butterfree", `\`p!shopbuy 6 gmax butterfree\``, true)
      .addField("Pikachu", `\`p!shopbuy 6 gmax pikachu\``, true)
      .addField("Meowth", `\`p!shopbuy 6 gmax meowth\``, true)
      .addField("Machamp", `\`p!shopbuy 6 gmax machamp\``, true)
      .addField("Gengar", `\`p!shopbuy 6 gmax gengar\``, true)
      .addField("Kingler", `\`p!shopbuy 6 gmax kingler\``, true)
      .addField("Lapras", `\`p!shopbuy 6 gmax lapras\``, true)
      .addField("Eevee", `\`p!shopbuy 6 gmax eevee\``, true)
      .addField("Snorlax", `\`p!shopbuy 6 gmax snorlax\``, true)
      .addField("Garbodor", `\`p!shopbuy 6 gmax garbodor\``, true)
      .addField("Melmetal", `\`p!shopbuy 6 gmax melmetal\``, true)
      .addField("Rillaboom", `\`p!shopbuy 6 gmax rillaboom\``, true)
      .addField("Cinderace", `\`p!shopbuy 6 gmax cinderace\``, true)
      .addField("Inteleon", `\`p!shopbuy 6 gmax inteleon\``, true)
      .addField("Corviknight", `\`p!shopbuy 6 gmax corviknight\``, true)
      .addField("Orbeetle", `\`p!shopbuy 6 gmax orbeetle\``, true)
      .addField("Drednaw", `\`p!shopbuy 6 gmax drednaw\``, true)
      .addField("Coalossal", `\`p!shopbuy 6 gmax coalossal\``, true)
      .addField("Flapple", `\`p!shopbuy 6 gmax flapple\``, true)
      .addField("Sandaconda", `\`p!shopbuy 6 gmax sandaconda\``, true)
      .addField("Toxtricity", `\`p!shopbuy 6 gmax toxtricity\``, true)
      .addField("Centiskorch", `\`p!shopbuy 6 gmax centiskorch\``, true)
      .addField("Hatterene", `\`p!shopbuy 6 gmax hatterene\``, true)
      .addField("Grimmsnarl", `\`p!shopbuy 6 gmax grimmsnarl\``, true)
      .addField("Alcremie", `\`p!shopbuy 6 gmax alcremie\``, true)
      .addField("Copperajah", `\`p!shopbuy 6 gmax copperajah\``, true)
      .addField("Duraludon", `\`p!shopbuy 6 gmax duraludon\``, true)
      .addField("Urshifu", `\`p!shopbuy 6 gmax urshifu\``, true)
      .setColor(color)
