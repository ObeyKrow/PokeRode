...
module.exports = {
   ...
   execute: async (client, message, args, prefix, guild, color, channel) => {
        let embed = new MessageEmbed()
            ...
            .setDescription(`PokeRode Is a New Generation Pokemon Bot With Various Features which will make discord a better place and make pokemon fans enjoy playing pokemon even in discord, We Adduing Z Moves / Animated Battles / More Catching Technique By Lowering Pokemon Hp / We So Far Have All Moves Working Enjoy Your Journey.
To Check Out The Other Commands Type : 
\`${prefix}help\` command.\nLike this: \`${prefix}help 2\`\n\n${client.user.username}'s Support Server: https://discord.gg/N7D4VgmnEt`)
            .addField("Page 1 | Getting Started!", `\`\`\`What you'll need to know to start using ${client.user.username}\`\`\``)
            .addField("Page 2 | Pokémon Commands!", `\`\`\`The main commands of the bot.\`\`\``)
            .addField("Page 3 | Pokémon Commands II!", `\`\`\`The main commands of the bot.\`\`\``)
            .addField("Page 4 | Shop, Market, Auction & Trading", `\`\`\`Commands to do with the shop and buying items Or Listing Them Or Trading Them.\`\`\``)
            ...
            .setFooter("Help Commands will be send to your DM(To Not Flood Channels).")
        ...
        let embed8 = new MessageEmbed()
            ...
            .setDescription(`Gamble with other trainer. \n\n**Note: Gamble At Your own risk, if you lose high amount of money the ${client.user.username} PokéRode Team won't be responsible for that and credits won't be returned.**`)
